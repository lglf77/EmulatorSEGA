...
public class i {
    ...
    protected static void c(Activity activity, Context context) {
        ...
        float f = ((float) defaultSharedPreferences.getInt("xAxisSensitivity", 30)) / 100.0f;
        float f2 = ((float) defaultSharedPreferences.getInt("yAxisSensitivity", 35)) / 100.0f;
        ...
        float parseInt3 = ((float) Integer.parseInt(defaultSharedPreferences.getString("audioStretchPercent", String.valueOf(2)))) / 100.0f;
    ...
    public static void e(Activity activity, Context context) {
        ...
        Emulator.setAnalog(e.h(context, 0), e.i(context, 0), e.j(context, 0), e.k(context, 0), e.l(context, 0), e.m(context, 0), e.n(context, 0), e.o(context, 0), z2);
        int a = e.a(context);
        for (int i = 0; i < a; i++) {
            Emulator.setButton(e.f(context, i), e.a(context, i), e.b(context, i), e.c(context, i), e.d(context, i), e.e(context, i), z2);
        }
    }
