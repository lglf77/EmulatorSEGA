...
class c extends GLSurfaceView {
    ...
    private static class b implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            Log.w(c.f, "creating OpenGL ES 2.0 context");
    ...
    private class C0018c implements GLSurfaceView.Renderer {
        short[] a;
        ...
        public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
            ...
            int i = rect.top;
            c.c = i + (window.findViewById(16908290).getTop() - i);
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 5 || actionMasked == 0) {
            ...
            Emulator.onTouchDown(motionEvent.getPointerId(actionIndex), motionEvent.getX(actionIndex), motionEvent.getY(actionIndex) - ((float) c), motionEvent.getSize(actionIndex));
        } else if (actionMasked == 6 || actionMasked == 1 || actionMasked == 3) {
            int actionIndex2 = motionEvent.getActionIndex();
            Emulator.onTouchUp(motionEvent.getPointerId(actionIndex2), motionEvent.getX(actionIndex2), motionEvent.getY(actionIndex2) - ((float) c), motionEvent.getSize(actionIndex2));
        } else if (actionMasked == 2) {
            int pointerCount = motionEvent.getPointerCount();
            for (int i = 0; i < pointerCount; i++) {
                Emulator.onTouchMove(motionEvent.getPointerId(i), (float) ((int) motionEvent.getX(i)), (float) (((int) motionEvent.getY(i)) - c), motionEvent.getSize(i));
            }
        }
        return true;
    }
