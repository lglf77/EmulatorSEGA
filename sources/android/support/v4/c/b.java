...
public final class b<E> implements Collection<E>, Set<E> {
    ...
    public boolean add(E e2) {
        ...
        if (i3 < this.i) {
            ...
            System.arraycopy(this.h, i3, this.h, i3 + 1, this.i - i3);
        }
        this.g[i3] = hashCode;
        this.h[i3] = e2;
        this.i++;
    ...
    public E c(int i2) {
        ...
        if (this.i <= 1) {
            ...
            if (i2 < this.i) {
                ...
                System.arraycopy(this.h, i2 + 1, this.h, i2, this.i - i2);
            }
            this.h[this.i] = null;
        } else {
            if (this.i > 8) {
            ...
            if (i2 < this.i) {
                ...
                System.arraycopy(objArr, i2 + 1, this.h, i2, this.i - i2);
            }
        }
        return e2;
    }
    ...
    public <T> T[] toArray(T[] tArr) {
        T[] tArr2 = tArr.length < this.i ? (Object[]) Array.newInstance(tArr.getClass().getComponentType(), this.i) : tArr;
        System.arraycopy(this.h, 0, tArr2, 0, this.i);
        if (tArr2.length > this.i) {
            tArr2[this.i] = null;
        }
        return tArr2;
    }
